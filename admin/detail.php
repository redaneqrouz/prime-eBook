										...
										<?php
											echo '	
												<a href="../'.$row['b_img'].'"><img src="../'.$row['b_img'].'"></a>
                                                            ...
                                                            Page : '.$row['b_page'].'<br>
                                                            <pri>Prix : '.$row['b_price'].' Dh</pri>
                                                            </frame>
                                                            </p>
                                                            <br><br><br><br><br><br><br>
                                                            
 <p><fieldset style="background-color:white;font-family:Ubuntu Condensed ,arial,sans-serif;width:98%"><legend>
 <h3>Description:</h3></legend>'.$row['b_desc'].' </fieldset>  </p>';
...
echo '<br>
<table><tr>
<td><a href="supprimerbook.php?id='.$row['b_id'].'"><div class="position1">Supprimer le livre</div></a></td>
<td><a href="modifierbook.php?id='.$row['b_id'].'"><div class="position2">Modifier le livre</div></a></td>
</tr></table>';
